...
export default function HomeScreen({ onBack, onNavigate }) { 
  ...
  const misCultivos = [
    { 
      ...
      img: "https://images.unsplash.com/photo-1592924357228-91a4daadcfea?q=80&w=400&auto=format&fit=crop" 
    },
    { 
      id: 2, 
      nombre: "Albahaca", 
      estado: "Revisar plaga", 
      color: "text-red-500", 
      img: "https://images.unsplash.com/photo-1618164436241-4473940d1f5c?q=80&w=400&auto=format&fit=crop" 
    },
    { 
      id: 3, 
      nombre: "Maracuyá", 
      estado: "Cosecha pronto", 
      color: "text-green-700", 
      img: "https://plus.unsplash.com/premium_photo-1723294490531-adb186f8e319?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
    },
    { 
      id: 4, 
      nombre: "T. Cherry", 
      ...
      img: "https://images.unsplash.com/photo-1546094096-0df4bcaaa337?q=80&w=400&auto=format&fit=crop" 
    },
    { 
      id: 5, 
      nombre: "Lechuga", 
      ...
      img: "https://images.unsplash.com/photo-1622206151226-18ca2c9ab4a1?q=80&w=400&auto=format&fit=crop" 
    },
  ];
    ...
    <div className="relative w-full h-screen max-w-[400px] mx-auto bg-white flex flex-col font-sans overflow-hidden shadow-2xl border-x border-gray-100">
      ...
      <div className="bg-[#389491]/55 backdrop-blur-md px-4 pt-5 pb-3 flex justify-between items-center shadow-sm z-20 sticky top-0 border-b border-white/10">
        ...
        <div className="flex flex-col items-center">
            <div className="w-8 h-8 rounded-full bg-orange-100 flex items-center justify-center text-orange-600 font-bold text-xs mb-1 border-2 border-white/80">
                A
            </div>
      ...
      {/* --- CONTENIDO SCROLEABLE (Agregada clase hide-scrollbar) --- */}
      <div className="flex-1 overflow-y-auto pb-24 hide-scrollbar z-10">
        ...
        <div className="px-6 mt-6">
          <div className="bg-white/30 backdrop-blur-lg p-5 rounded-3xl shadow-sm border border-white/20">
            ...
            <p className="text-orange-500 text-sm font-medium mb-4">
              3 de 5 cultivos necesitan cuidados
            </p>
        ...
        <div className="mt-8 relative group">
          ...
          <button 
            onClick={() => scroll('left')}
            className="absolute left-2 top-1/2 z-20 bg-white/90 p-2 rounded-full shadow-lg text-gray-700 hover:bg-white hidden group-hover:block"
          >
            <ChevronLeft size={20} />
          </button>
          ...
          <button 
            ...
            className="absolute right-2 top-1/2 z-20 bg-white/90 p-2 rounded-full shadow-lg text-gray-700 hover:bg-white hidden group-hover:block"
          >
            <ChevronRight size={20} />
          </button>

          {/* SCROLL HORIZONTAL (Agregada clase hide-scrollbar) */}
          <div 
            ref={scrollContainerRef}
            className="flex overflow-x-auto px-6 gap-4 pb-4 hide-scrollbar snap-x scroll-smooth"
          >
            {misCultivos.map((cultivo) => (
                <div key={cultivo.id} className="min-w-[140px] snap-center cursor-pointer hover:scale-95 transition-transform duration-300">
                  ...
                  <p className={`${cultivo.color} text-xs font-bold bg-white/60 inline-block px-2 py-0.5 rounded-md backdrop-blur-sm`}>
                    {cultivo.estado}
                  </p>
                </div>
            ))}
        ...
        <div className="px-6 mt-4">
          ...
          <div className="flex flex-col gap-4">
            <div className="bg-white/40 backdrop-blur-lg p-3 rounded-2xl shadow-sm border border-white/20 flex items-center gap-4 hover:bg-white/20 transition-colors cursor-pointer">
      ...
      {/* CSS FORZADO PARA OCULTAR BARRAS */}
      <style>{`
